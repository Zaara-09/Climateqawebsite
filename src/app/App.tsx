...
import { Cloud, FileText, MessageSquare, Wind } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Tab Navigation */}
        <div className="mb-6">
          <div className="flex gap-2 bg-white p-1 rounded-lg shadow-sm border border-gray-200 inline-flex">
            <button
